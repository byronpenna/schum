...
@media(min-width:768px){	
	...
	.parentBoxSummary > div:nth-child(2) > div{
	...
	/*Agent for this listings*/
		...
		/*agent text*/
		.contactAgentText > .row:nth-child(3){
			margin-top: 3%;
		}

		/*Img linstings*/
		.contactAgentText > .row:nth-child(3) > .contactAgent:nth-child(1) > img{
			width: 20%;
		}

		/*Img email*/
		.contactAgentText > .row:nth-child(3) > .contactAgent:nth-child(2) > img{
			width: 15%;
		}

		/*p agent*/
		.contactAgentText > .row:nth-child(4){
			margin-top: 3%;
			font-size: 0.7em;
		}
...
@media(min-width:1700px){
		...
		.contactAgentText > .row:nth-child(5) button{
