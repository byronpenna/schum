...
.miClaseChula > .selecter > .selecter-selected {
	text-align: left;
	width: 350% !important;
	z-index: 100 !important;
}
.miClaseChula > .selecter > .selecter-options {
	text-align: left;
	width: 350% !important;
	z-index: 100 !important;
}
...
/*lllllllllllllllllllllllllllllllllll*/
/*Display by 2.0*/
@media(min-width:1480px) and (max-width:1849px){
.btnSearchNow > .lupita {
	font-size: 110%;
}
.serchi {
...
@media(min-width:1200px){
	...
	/*ahhh */
        ...
        .textEstadoCasa{
			...
			font-size: 4em;
			font-weight: 900;
            text-shadow: 2px 3px 5px #FFF, -3px 3px 1px #FFF, 2px 2px 0px #FFF, 2px -2px 0px #FFF, 1px 1px #FFF, -3px -3px 0px #FFF, 3px -3px 0px #FFF, -3px 3px 0px #FFF;
            border: 5px;
		}
		.titleFootDescriptionCasa, .desFootDescriptionCasa{
			font-size: 0.8em;
