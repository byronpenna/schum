					...
					<div class="col-lg-12 col-md-12 ">
						<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 paddingNull searchMapSection">
							...
							<div class="row lateralSeachBody">
								<div class="col-lg-12">
									<div class="row">
										<select class="form-control cbMapSearch">
						...
						<div class="red col-xs-12 col-sm-9 col-md-9 col-lg-9 paddingNull mapIdiota " >
				...
				<div class="row container-fluid	">
					<div class="row container-fluid">
						...
						<div class="col-lg-offset-6 col-lg-2 text-right n-navNewsSection">
							<img class='navNewToMarket' direccion='0' src=<?php echo "'".base_url("img/elements/news_to_market/navLeft.png")."'"; ?> />
							<img class='navNewToMarket' direccion='1' src=<?php echo "'".base_url("img/elements/news_to_market/navRight.png")."'"; ?> />
						</div>
			...
			<div class="row videoSection container-fluid">
				...
				<div class="row container-fluid">
					...
					<div class="col-lg-offset-6 col-lg-2 text-right navEmpSection">
						<img class='navEmpleados' src=<?php echo "'".base_url("img/elements/ourteam/navLeft.png")."'"; ?> />
						<img class='navEmpleados' src=<?php echo "'".base_url("img/elements/ourteam/navRight.png")."'"; ?> />
					</div>
				</div>
